...
function Contact() {
    ...
    return (
        <>
            <Head>
                <title>Neuraserv | Contact</title>
                <meta name="description" content="Get in touch with Neuraserv. Whether you have questions, ideas, or project inquiries, our team is here to help you build the future. Reach out today." />
            </Head>
            <div>
